...
# DVE full session
# Saved on Wed May 22 00:00:59 2024
# Designs open: 1
#   Sim: /Users/students/cadiga/850/850/simv
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: _vcs_unit__4286234733.\scoreboard::wrap_up 
#   Group count = 1
...
#<Session mode="Full" path="/Users/students/cadiga/850/850/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1541 917}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 172} {height 610} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 610
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 172} {height 610} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1533} {height 177} {dock_state bottom} {dock_on_new_line true}}
...
if { ![gui_is_db_opened -db {/Users/students/cadiga/850/850/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /Users/students/cadiga/850/850 -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_1" { top.dut.sum top.dut.in top.dut.rst top.dut.clk top.dut.carry top.dut.sum_in }
...
catch { gui_list_select -id ${Data.1} {top.dut.sum top.dut.in top.dut.rst top.dut.clk top.dut.carry top.dut.sum_in }}
...
gui_open_source -id ${Source.1}  -replace -active {_vcs_unit__4286234733.\scoreboard::wrap_up } /Users/students/cadiga/850/850/./scoreboard.sv
