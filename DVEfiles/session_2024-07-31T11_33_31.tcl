...
# DVE full session
# Saved on Wed Jul 31 11:33:31 2024
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{51 109} {1519 981}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 425} {child_wave_right 1038} {child_wave_colname 210} {child_wave_colvalue 210} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /Users/students/cadiga/DV/850/850 -nosource
}
}
